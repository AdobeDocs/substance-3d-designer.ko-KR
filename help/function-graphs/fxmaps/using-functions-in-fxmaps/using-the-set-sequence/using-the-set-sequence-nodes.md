...
![노드 설정 및 시퀀스](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-01.png "노드 설정 및 시퀀스")
...
![노드 설정](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-02.png "노드 설정")
...
![노드 예 설정](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-03.png "노드 예 설정")
...
![시퀀스 노드](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-04.png "시퀀스 노드")
...
![시퀀스 노드 예](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-05.png "시퀀스 노드 예")
...
![시퀀스 노드 연결](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-06.png "시퀀스 노드 연결")
...
![사분면 속성](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-07.png "사분면 속성")
...
![사분면 색상/광도 함수](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-08.png "사분면 색상/광도 함수")

</td>
</tr>
</table>

![흩어진 패턴](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-09.png "흩어진 패턴")
...
![패턴 회전의 매개 변수 함수 메뉴](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-10.png "패턴 회전의 매개 변수 함수 메뉴")
...
![패턴 회전의 부동 소수점 출력 가져오기](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-11.png "패턴 회전의 부동 소수점 출력 가져오기")
...
![회전된 패턴](using-the-set-sequence-nodes.resources/using-the-set-sequence-nodes-12.png "회전된 패턴")
