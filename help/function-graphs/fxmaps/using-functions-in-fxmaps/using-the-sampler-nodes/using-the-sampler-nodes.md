...
breadcrumb-title: ''
description: FXMaps에서 샘플러 노드를 사용하여 텍스처를 샘플링하고 절차적 재질 변형을 만드는 방법을 알아봅니다.
...
[![SBS 파일 아이콘](../../../../assets/sbs-1_1.png){width="64px"}](https://shared-assets.adobe.com/link/d5f9adf3-0bb5-49a1-4eb9-a0506d4f3f32)
