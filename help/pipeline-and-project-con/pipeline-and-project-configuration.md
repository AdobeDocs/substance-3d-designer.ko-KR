...
Substance 3D Designer은 파이프라인 사용을 위해 애플리케이션을 구성하는 강력한 시스템을 갖추고 있습니다. 계층적 &quot;**프로젝트**&quot; 파일의 고급 시스템을 통해 응용 프로그램을 Studio 또는 프로젝트 표준에 맞게 즉시 구성할 수 있으며, 모든 구성 및 라이브러리 콘텐츠가 버전 컨트롤 상태입니다. 이 시스템의 주요 목표는 모든 파이프라인 관련 설정을 중앙 집중화하면서도 여러 구성이 서로 오버라이드하고 확장할 수 있도록 하는 것입니다.
...
![구성 파일 계층 구조](pipeline-and-project-configuration.resources/filestructureoverview.png "구성 파일 계층 구조")
...
1. <b>관련 [SBSPRJ 파일](../pipeline-and-project-con/project-configuration-fil/project-configuration-files-sbsprj.md)을 만들고 버전 컨트롤 아래에 해당 파일과 내용을 배치합니다.</b> *별도의 저장소*&#x200B;를 만들어 실제 프로젝트 콘텐츠 및 리소스(3D 모델, 텍스처, 코드)에서 Designer 파이프라인 및 라이브러리 콘텐츠를 분리하는 것이 좋습니다.
1. <b>모든 프로젝트 파일을 나열하는 [&#x200B; SBSCFG configuration](../pipeline-and-project-con/configuration-list-sbscfg/configuration-list-sbscfg.md) 파일을 만들고 버전 컨트롤 아래에 둡니다</b>. 프로젝트가 여러 개인 경우에는 모든 프로젝트에 대해 구성을 만들 수 있습니다.
