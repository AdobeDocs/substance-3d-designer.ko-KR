...
## ![(오류)](../../assets/error.svg) 잘못된 종속 패키지
...
1. <b>종속성 로드 성공</b>
   ...
   그런 다음 [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) 패널에서 RMB를 클릭하고 컨텍스트 메뉴에서 <b>다시 로드</b> 옵션을 선택하여 호스트 패키지를 다시 로드합니다.

   ![&#39;잘못된 종속 패키지&#39; 솔루션 1](../../assets/warnings-dep-invalid-dependent-pkg.gif "&#39;잘못된 종속 패키지&#39; 솔루션 1")
1. <b>패키지에서 종속성 재배치</b>

   [종속성 관리자](../../interface/dependency-manager/dependency-manager.md) 를 사용하여 종속성을 재배치할 수 있습니다. [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) 패널에서 호스트 패키지의 RMB를 클릭하고 컨텍스트 메뉴에서 <b>종속성 관리자</b> 옵션을 선택합니다.
...
## ![(오류)](../../assets/error.svg) *&#39;X&#39;* 별칭이 프로젝트에 정의되어 있는지 확인하십시오.
...
![&#39;확인 별칭이 정의됨&#39; 솔루션](../../assets/warnings-dep-alias.gif "&#39;확인 별칭이 정의됨&#39; 솔루션")

## ![(오류)](../../assets/error.svg) 이 리소스와 일치하는 파일을 찾을 수 없습니다
...
1. <b>파일 재배치</b>
   ...
   파일이 이동되었거나 이름이 바뀐 경우 [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) 패널의 리소스 항목에서 RMB를 클릭하여 파일을 재배치하고 <b>재배치</b> 옵션을 선택하여 해당 리소스를 동일한 유형의 UDIM 이미지 집합&#x200B;*의 첫 번째 파일에 연결합니다.*

   ![&#39;리소스와 일치하는 파일 없음&#39; 해결 방법 2](../../assets/warnings-dep-udim.gif "&#39;리소스와 일치하는 파일 없음&#39; 해결 방법 2")

## ![(오류)](../../assets/error.svg) 연결된 파일을 찾을 수 없습니다.
...
1. <b>파일 재배치</b>
   ...
   파일이 이동되었거나 이름이 바뀐 경우 [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) 패널의 리소스 항목에서 RMB를 클릭하여 파일을 재배치하고 <b>재배치</b> 옵션을 선택하여 해당 리소스를 동일한 유형의 다른 파일에 연결합니다.

   ![&#39;연결된 파일을 찾을 수 없음&#39; 해결 방법 2](../../assets/warnings-dep-file-not-found-2.gif "&#39;연결된 파일을 찾을 수 없음&#39; 해결 방법 2")

## ![(오류)](../../assets/error.svg) 색상 공간을 찾을 수 없음
...
![&#39;색상 공간을 찾을 수 없음&#39; 해결 방법](../../assets/warnings-dep-color-space.gif "&#39;색상 공간을 찾을 수 없음&#39; 해결 방법")

## ![(오류)](../../assets/error.svg) 참조 리소스를 찾을 수 없습니다.

[3D 메시 리소스](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/3d-mesh-resource-200574577.html)의 UV 타일에 할당된 그래프를 경고에 보고된 위치에서 찾을 수 없습니다.
...
1. <b>그래프 복원</b>
   ...
   [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html) 패널에서 패키지의 내용에 <b>UV 타일</b> 목록에 지정된 그래프가 있는지 확인합니다. 존재하지 않는 경우 복원하거나 다시 만듭니다.
...
1. <b>다른 그래프 선택</b>
   ...
   ![&#39;참조 리소스를 찾을 수 없음&#39; 해결 방법 1](../../assets/warnings-dep-udim-graph.gif "&#39;참조 리소스를 찾을 수 없음&#39; 해결 방법 2")

## ![(오류)](../../assets/error.svg) UV 타일이 여러 번 할당됨

[3D 메시 리소스](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/3d-mesh-resource-200574577.html)에 대한 UV 타일이 [Substance 그래프](../../compositing-graphs/substance-compositing-graphs.md)에 두 번 이상 할당되었습니다.

<b>![(틱)](../../assets/check.svg) 솔루션</b>

3D 메시 리소스의 각 UV 집합에 대해 <b>UV 타일</b> 목록에 *두 번 이상* UDIM 인덱스가 없는지 확인하십시오.

![&#39;UV 타일이 여러 번&#39; 솔루션에 할당됨](../../assets/warnings-dep-udim-same.gif "&#39;UV 타일이 여러 번&#39; 솔루션에 할당됨")

## ![(오류)](../../assets/error.svg) 잘못된 UV 타일

[3D 메시 리소스](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/3d-mesh-resource-200574577.html)에 대해 나열된 UV 타일이 메시에 정의되어 있지 않거나 손상되었습니다.
