...
* 리소스를 [탐색기](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/the-explorer-129368147.html)에 로드한 상태에서 *RMB*&#x200B;을(를) 클릭하고 상황에 맞는 메뉴에서 <b>모델 정보 굽기</b> 옵션을 선택합니다
