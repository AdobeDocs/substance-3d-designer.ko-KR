...
AxF 파일에서 추출한 텍스처의 *식별자*&#x200B;과 *사용량*&#x200B;이 일치하는 [입력](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/input-color/input-color.md) 텍스처의 경우 해당 입력 노드는 해당 노드를 참조하는 [비트맵](../../compositing-graphs/nodes-reference-for-com/atomic-nodes/bitmap/bitmap.md) 노드로 대체됩니다.
