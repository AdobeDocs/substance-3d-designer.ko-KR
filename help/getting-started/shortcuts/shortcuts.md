...
| 액션 | Windows | macOS |
|:-----------------------------------------------------------------------------------|:---------------------------------------|:-------------------------------------|
| 확대/축소 | 마우스 휠<br>Alt + RMB + 드래그 | 마우스 휠<br>⌥ + RMB + 드래그 |
| 빠른 확대/축소 | ⇧ + 마우스 휠<br>⇧ + Alt + RMB + 드래그 | ⇧ + 마우스 휠<br>⇧ + ⌥ + RMB + 드래그 |
| 패닝 | MMB + 드래그<br>Ctrl + RMB + 드래그 | MMB + 드래그<br>⌘ + RMB + 드래그 |
| 확대/축소 재설정 | Z | Z |
| 보기에 맞추기 | F | F |
| 복사 | Ctrl + C | ⌘ + C |
| 붙여넣기 | Ctrl + V | ⌘ + V |
...
| 액션 | Windows | macOS |
|:---------------------------------------------------------|:--------------------------------|:-----------------------------|
| 돌리 카메라(앞/뒤 팬) | 마우스 휠<br>Alt + RMB + 드래그 | 마우스 휠<br>⌥ + RMB + 드래그 |
| 궤도 카메라 | LMB + 드래그 | LMB + 드래그 |
| 트럭 및 페데스탈 카메라(측면 및 수직 팬) | MMB + 드래그<br>Ctrl + RMB + 드래그 | MMB + 드래그<br>⌘ + RMB + 드래그 |
