...
Designer을 처음 실행하면 활성화 마법사가 열리고 활성화 프로세스가 안내됩니다.
...
<table data-preserve-html="true">
    <tbody>
        ...
        <tr>
            <td rowspan="2" style="text-align: left;"><b>11.1</b> 이하</td>
            <td style="text-align: left;"><code>AppData&#92;Local</code></td>
        ...
        <tr>
            ...
            <td style="text-align: left;"><b>11.2</b> 이상<br/></td>
        ...
        <tr>
            <td style="text-align: left;"><b>11.1</b> 이하<br/></td>
        ...
        <tr>
            <td rowspan="2" style="text-align: left;"><b>리눅스</b></td>
...
>[!IMPORTANT]
>
> 파일이 `license.key`(으)로 호출되었는지 확인하십시오. 그렇지 않으면 응용 프로그램에서 파일을 찾을 수 없습니다.

### 환경 변수

Designer에서 `license.key` 파일에 대해 확인하는 위치를 [환경 변수](../../pipeline-and-project-con/environment-variables/environment-variables.md)(으)로 재정의할 수 있습니다.
