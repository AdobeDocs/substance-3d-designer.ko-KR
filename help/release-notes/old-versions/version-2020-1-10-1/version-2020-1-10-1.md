---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/release-notes/old-versions/version-2020-1-10-1.html"
breadcrumb-title: ''
...
* **새 정규화 설정**\
  Thickness 및 Heightmap 베이커에는 0~1 범위의 고정된 값 대신 텍스처에 원시 값을 구울 수 있는 새로운 정규화 매개 변수가 있습니다. 이는 예를 들어 저-폴리 및 고-폴리 메시 사이의 원시 거리들을 알기 위해 Height 맵에서 유용하다. 제수 값은 높은-폴리 메쉬 실루엣과 일치하도록 낮은-폴리 메쉬 상에 셋업하기 위한 변위 강도에 정확히 대응한다. Height 맵을 올바르게 해석하기 위해 0에 해당하는 픽셀 값을 정의하기 위해 새로운 &quot;스칼라 제로 값&quot; 매개 변수를 노출했습니다. 또한 수동 요소를 사용하면 UV 타일 단위 정규화로 인해 발생하는 UDIM 메시의 잠재적인 연결 문제를 수정할 수 있습니다.
...
* **텍스처 입력 미리 보기 표시 및 사용 안 함 매개 변수 추가**\
  셰이더 입력 매개 변수는 이제 해당 입력의 미리 보기를 표시합니다. 유니폼 색상 매개 변수, 그래프 노드 또는 비트맵일 수 있습니다. 매개변수를 선택 해제하여 일시적으로 비활성화할 수도 있습니다.

  ![](version-2020-1-10-1.resources/3dview-map-preview.png)

  ![](version-2020-1-10-1.resources/3dview-enable-setting.gif)
* **설정의 환경 맵 미리 보기**\
  **3D 보기 > 환경 > 편집**&#x200B;으로 이동하면 장면을 비추는 데 사용되는 환경 맵의 미리 보기가 있습니다.

  ![](version-2020-1-10-1.resources/3dview-env-settings.jpg)
* **조명되지 않은 새 셰이더**\
  &quot;unlit&quot;이라는 새 셰이더가 기본적으로 포함되었습니다. 이 효과는 어떠한 조명에도 반응하지 않으며, 대신 메시를 통해 뷰포트에 단일 텍스처를 표시하는 데 사용할 수 있습니다. 예를 들어, 구운 텍스처를 확인하는 데 유용합니다.
