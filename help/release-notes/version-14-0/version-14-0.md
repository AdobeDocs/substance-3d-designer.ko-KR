...
![색상 정량화 2](../../assets/GIF3_2.gif){zoomable="yes"}
...
![2d 보기](../../assets/2dview.gif){width="320px" zoomable="yes"}
...
![함수 편집](../../assets/functionedit.png){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![함수 2](../../assets/functionedit2.png){zoomable="yes"} 편집
