...
![장면 재질을 재정의하고 수정하여 장면 상태로 재설정](../../assets/tweakOverriddenMaterial.gif "장면 재질을 재정의하고 수정하여 장면 상태로 재설정"){zoomable="yes"}
...
![재질 재정의 - &#39;3D 보기&#39; 뷰포트에서 동작](../../assets/overrideMaterialActionViewport.png "재질 재정의 - &#39;3D 보기&#39; 뷰포트에서 동작"){zoomable="yes"}
...
![재질 재정의 - &#39;재질&#39; 메뉴의 동작](../../assets/overrideMaterialActionMaterials.png "재질 재정의 - &#39;재질&#39; 메뉴의 동작"){zoomable="yes"}
...
![재질을 장면 상태로 재설정 - &#39;3D 보기&#39; 뷰포트에서 작업](../../assets/resetMaterialToSceneStateActionViewport.png "재질을 장면 상태로 재설정 - &#39;3D 보기&#39; 뷰포트에서 작업"){zoomable="yes"}
...
![재질을 장면 상태로 재설정 - &#39;재질&#39; 메뉴의 동작](../../assets/resetMaterialToSceneStateActionMaterials.png "재질을 장면 상태로 재설정 - &#39;재질&#39; 메뉴의 동작"){zoomable="yes"}
...
![재질을 장면 상태로 재설정 - &#39;속성&#39; 도크에서 동작](../../assets/resetMaterialToSceneStateActionProps.png "재질을 장면 상태로 재설정 - &#39;속성&#39; 도크에서 동작"){zoomable="yes"}
...
![장면 상태로 재설정 - 재질 속성에서 동작](../../assets/resetPropertyToSceneStateAction.png "장면 상태로 재설정 - 재질 속성에서 동작"){zoomable="yes"}
...
![재질 재정의 - 데이터 도식](../../assets/overridingMaterialsSchematic.png "재질 재정의 - 데이터 도식"){zoomable="yes"}
...
![재질 연결](../../assets/connectMaterials.gif "재질 연결"){zoomable="yes"}
