...
![(오류)](parameters-not-working-as-expected.resources/error.svg) <b>문제</b>
...
![(틱)](parameters-not-working-as-expected.resources/check.svg) <b>권장 단계</b>
...
*음의 정수*&#x200B;를 사용할 때 노드 매개 변수에 적용된 Substance 함수 그래프가 예상 값을 출력하지 않습니다.
