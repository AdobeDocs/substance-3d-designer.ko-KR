---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/technical-issues/incorrect-image-output.html"
breadcrumb-title: ''
...
* **부동 소수점**&#x200B;은 16비트(HDR 16F) 및 32비트(HDR 32F) 정밀도를 제공하며 음수 값을 포함하여 0-1 범위를 벗어난 값을 저장하는 기능을 제공합니다. 이를 통해 광도 값이 1.0을 훨씬 초과할 수 있는 High Dynamic Range(HDR) 이미지로 작업할 수 있습니다.
