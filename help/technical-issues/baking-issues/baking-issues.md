...
이 페이지에는 Substance 3D Designer의 [텍스처 굽기](../../bakers/bakers.md)와 관련된 기술 문제가 나열되어 있으며 각각에 대한 문제 해결 단계를 제공합니다.
...
Designer 버전 14.1 이하에서 낮은 폴리 및 높은 폴리 개체는 해당 *상위* 개체의 이름을 사용하여 일치했습니다. 대부분의 경우 상위 변환입니다.
...
* [프로젝트] 설정에서 [&#39;이름 필터링 모드&#39; 옵션](../../interface/preferences-window/project-settings/project-settings.md)을(를) 조정하여 비헤이비어 또는 이전 Designer 버전으로 되돌립니다.
  1. 편집 > 환경 설정 > 프로젝트로 이동합니다.
  1. 목록에서 마지막 프로젝트 파일 선택
  1. 프로젝트 파일 목록 아래에서 &#39;베이커&#39; 탭을 선택합니다
  1. &#39;이름 필터링 모드&#39;을 &#39;부모 이름(레거시)&#39;으로 설정
