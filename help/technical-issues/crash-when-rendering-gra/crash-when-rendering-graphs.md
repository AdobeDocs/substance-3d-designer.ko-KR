...
breadcrumb-title: ''
description: Substance 3D Designer에서 그래프를 렌더링할 때 발생하는 충돌을 해결하고 이러한 문제를 방지하기 위한 솔루션을 찾습니다.
...
<b>[![(오류)](crash-when-rendering-graphs.resources/error.svg)](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/technical-support/technical-issues/gpu-issues/gpu-drivers-crash-with-long-computations-tdr-crash) 문제</b>
...
<b>![(틱)](crash-when-rendering-graphs.resources/check.svg) 권장 단계</b>
