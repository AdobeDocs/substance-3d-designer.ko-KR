---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/technical-issues/cannot-create-load-a-project.html"
breadcrumb-title: ''
...
**![(오류)](cannot-create-load-a-project.resources/error.svg) 문제**
...
**![(틱)](cannot-create-load-a-project.resources/check.svg) 권장 단계**
...
* <b>[Substance3d.com](http://Substance3d.com) 구독:</b> Substance 3D Designer에 메시지가 표시되면 업데이트하거나 [Substance3d.com](http://substance3d.com) 웹 사이트의 [내 라이선스](https://store.substance3d.com/user) 섹션에서 최신 설치 관리자를 다운로드합니다
...
<b>![(오류)](cannot-create-load-a-project.resources/error.svg) 문제</b>

프로젝트를 만들거나 로드할 때 충돌은 작업 영역을 설정할 때 발생하는 [3D 보기](../../interface/3d-view/3d-view.md)의 초기화 중 오류로 인해 발생하는 경우가 많습니다.

시스템이 랩톱인 경우 타사 응용 프로그램이 3D 보기가 시스템 GPU를 사용하지 못하도록 하는 *전원 관리 계획*&#x200B;을 적용할 수 있습니다. 이로 인해 다른 GPU 장치가 그 자리에서 작업을 수행할 수 없는 경우 충돌이 발생할 수 있습니다.

세션 간에 *표시 구성 또는 크기 조정*&#x200B;이 변경되어 3D 보기 렌더링 프레임이 잘못된 좌표에서 만들어지는 경우에도 충돌이 발생할 수 있습니다.

<b>![(틱)](cannot-create-load-a-project.resources/check.svg) 권장 단계</b>

이 충돌의 여러 가능한 원인을 고려하여 다음 문제 해결 단계를 순서대로 진행하시기 바랍니다.
...
일부 전력 관리 애플리케이션은 시스템의 GPU에 대한 다른 애플리케이션의 액세스를 제한하거나 GPU의 성능을 방해할 수 있으며, 이는 충돌을 초래할 수 있다. 전원 관리 애플리케이션이 있고 활성 상태이면 최상의 성능을 제공하는 플랜으로 전환하십시오.
...
충돌이 디스플레이 구성 또는 비율 변경으로 인해 발생하는 경우, Designer에서 사용자 인터페이스를 완전히 재설정하기 위해 기존 레지스트리 항목을 삭제할 수 있습니다.
