...
![기본 매개 변수](../../assets/doc-graph-props-base-params.png "기본 매개 변수"){width="512px" zoomable="yes"}
...
|                      |                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|:---------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <b>출력 크기</b> | 이 매개 변수를 사용하면 그래프에서 이미지의 *기본 해상도*&#x200B;를 선택할 수 있습니다.  사용: <div><img data-preserve-html="true" height="22" src="../../assets/props-output-size-lock.jpg"/></div> 크기를 조정할 때 높이 및 폭 값이 일치하도록 단추를 잠그고 이미지의 정사각형을 유지합니다.<br><br>*기본값: (0,0) - 부모에 대한 상대* [자세히 알아보기](../../compositing-graphs/output-size/output-size.md) |
...
| <b>임의 시드</b> | 그래프의 기본 *임의 시드*&#x200B;를 정의합니다.  사용: <div><img data-preserve-html="true" height="22" src="../../assets/prop-randomise.jpg"/></div> 임의의 시드에 새 임의의 값을 할당하는 단추입니다.<br><br>*기본값: 0 - 부모에 대한 상대* |
...
![그래프 특성](../../assets/doc-graph-props-attributes.png "그래프 특성"){zoomable="yes"}
...
| **유형** | <b>유형</b>은 [Substance 그래프](../../compositing-graphs/substance-compositing-graphs.md)의 의도된 목적을 정의하는 데 사용됩니다. 주로 [&#39;Send&#39; 상호 운용성 기능](../../interface/the-explorer-window/send-to-interoperability/send-to-interoperability.md)[.](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/send-to-215286290.html)을(를) 대상으로 합니다. |
...
![입력 매개 변수](../../assets/doc-graph-props-input-parameters.png "입력 매개 변수"){zoomable="yes"}
...
![입력](../../assets/doc-graph-props-inputs.png "입력"){zoomable="yes"}
...
![출력](../../assets/doc-graph-props-outputs.png "출력"){zoomable="yes"}
