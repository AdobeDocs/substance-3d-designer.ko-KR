...
![Atomic node: 입력 값](input-value.resources/comp_inputnumeric_1.png "Atomic node: 입력 값"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="input-value.resources/input-value-tooltip.gif" alt="입력 값 도구 설명" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
...
![Substance 그래프의 기본 입력](input-value.resources/node-primary-input.png)
