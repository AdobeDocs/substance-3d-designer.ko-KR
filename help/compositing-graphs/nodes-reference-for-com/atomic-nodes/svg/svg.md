...
breadcrumb-title: ""
description: SVG 노드를 사용하여 SVG 벡터 그래픽을 가져와 확장 가능한 그래픽 요소를 만들기 위한 텍스처로 렌더링합니다.
...
<div data-preserve-html="true" style="text-align: center;"><img src="svg.resources/svg-tooltip.gif" alt="svg 툴팁" /></div>
