...
![Atomic node: 입력 색상](input-color.resources/comp_inputcolor_1.png "Atomic node: 입력 색상")
...
<div data-preserve-html="true" style="text-align: center;"><img src="input-color.resources/input-color-tooltip.gif" alt="입력 색상 도구 설명" /></div>
...
![Substance 그래프의 기본 입력](input-color.resources/node-primary-input.png)
