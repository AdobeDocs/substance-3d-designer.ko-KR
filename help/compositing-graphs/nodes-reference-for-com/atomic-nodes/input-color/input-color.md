...
breadcrumb-title: ""
description: '[입력 색상] 노드를 사용하여 사용자가 표시하고 조정할 수 있는 Substance 그래프의 색상 입력 매개 변수를 만듭니다.'
...
![Atomic node: 입력 색상](input-color.resources/comp_inputcolor_1.png "Atomic node: 입력 색상"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="input-color.resources/input-color-tooltip.gif" alt="입력 색상 도구 설명" /></div>
...
![Substance 그래프의 기본 입력](input-color.resources/node-primary-input.png){width="20%"}
