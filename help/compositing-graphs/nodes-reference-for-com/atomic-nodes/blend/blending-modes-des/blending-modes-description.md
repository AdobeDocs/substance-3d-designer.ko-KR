...
![혼합 모드: 복사](../../../../../assets/image2015-8-20-9-38-0.png "혼합 모드: 복사"){zoomable="yes"}

색상 이미지의 경우 기본적으로 불투명도에서 알파 채널이 고려됩니다.

&#39;Alpha 혼합&#39; 매개 변수를 사용하여 변경할 수 있습니다.

![혼합 모드: 복사(2)](../../../../../assets/image2015-8-20-14-15-29.png "혼합 모드: 복사(2)"){zoomable="yes"}

## 추가(선형 닷지)

*추가* 혼합 모드를 사용하면 배경의 각 해당 픽셀에 전경 입력 값이 추가됩니다.

![혼합 모드: 추가(선형 닷지)](../../../../../assets/image2015-8-20-9-38-19.png "혼합 모드: 추가(선형 닷지)"){zoomable="yes"}
...
![혼합 모드: 빼기](../../../../../assets/image2015-8-20-9-38-35.png "혼합 모드: 빼기"){zoomable="yes"}
...
![혼합 모드: 곱하기](../../../../../assets/image2015-8-20-9-38-53.png "혼합 모드: 곱하기"){zoomable="yes"}
...
![혼합 모드: 하위 항목 추가](../../../../../assets/image2015-8-20-9-39-11.png "혼합 모드: 하위 항목 추가"){zoomable="yes"}

## 최대(밝게)

*최대* 혼합 모드는 배경과 전경 중 더 높은 값을 선택합니다.

![혼합 모드: 최대(밝게)](../../../../../assets/image2015-8-20-9-40-12.png "혼합 모드: 최대(밝게)"){zoomable="yes"}

## 최소(어둡게)

*최소* 혼합 모드는 배경과 전경 중 더 낮은 값을 선택합니다.

![혼합 모드: 최소(어둡게)](../../../../../assets/image2015-8-20-9-40-31.png "혼합 모드: 최소(어둡게)"){zoomable="yes"}
...
![혼합 모드: 전환](../../../../../assets/image2015-8-20-9-38-0.png "혼합 모드: 전환"){zoomable="yes"}

## 나누기

*나누기* 혼합 모드는 배경 입력 픽셀 값을 전경의 해당 픽셀로 나눕니다.

![혼합 모드: 나누기](../../../../../assets/image2015-8-20-9-41-32.png "혼합 모드: 나누기"){zoomable="yes"}
...
![혼합 모드: 오버레이](../../../../../assets/image2015-8-20-9-41-50.png "혼합 모드: 오버레이"){zoomable="yes"}
...
![혼합 모드: 화면](../../../../../assets/image2015-8-20-9-42-11.png "혼합 모드: 화면"){zoomable="yes"}
...
![혼합 모드: 소프트 라이트](../../../../../assets/image2015-8-20-9-42-32.png "혼합 모드: 소프트 라이트"){zoomable="yes"}
