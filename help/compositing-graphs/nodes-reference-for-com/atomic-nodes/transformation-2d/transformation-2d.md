...
![Atomic node: 변환 2D](transformation-2d.resources/comp_transformation_1.png "Atomic node: 변환 2D"){width="100%"}
...
<td style="border: 0; text-align: center" align="center"><img src="transformation-2d.resources/transformation2d-tooltip.gif" alt="transformation-2d 도구 설명" /></td>
<td style="border: 0; width: 15%" width="15%"></td>
</tr>
</table>
