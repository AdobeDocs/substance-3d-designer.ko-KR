...
![Atomic node: 채널 재편성](channel-shuffle.resources/comp_shuffle.png "Atomic node: 채널 재편성"){width="20%"}
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="channel-shuffle.resources/channels-shuffle-tooltip.gif" alt="채널 순서 섞기 도구 설명" /></div>
