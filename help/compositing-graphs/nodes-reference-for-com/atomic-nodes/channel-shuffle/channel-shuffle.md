...
breadcrumb-title: ""
description: 색상 효과를 만들고 텍스처를 바꾸기 위해 채널의 색상 채널을 다시 정렬하려면 채널 재편성 노드를 사용합니다.
...
![Atomic node: 채널 재편성](channel-shuffle.resources/comp_shuffle.png "Atomic node: 채널 재편성")
...
즉, 두 개의 입력을 취하여 빨간색, 녹색, 파란색 및 알파 채널 중 하나를 전환하거나 입력의 채널 중 하나로 설정한 상태에서 출력을 반환할 수 있습니다.
...
| <b>알파 채널</b> *정수* | 출력 이미지의 알파 채널에 삽입할 소스 채널을 선택합니다. |
