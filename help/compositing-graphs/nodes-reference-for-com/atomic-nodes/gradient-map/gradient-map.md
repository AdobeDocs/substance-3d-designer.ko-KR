...
![원자 노드: 그레이디언트 맵](gradient-map.resources/gradient-map-01.png "원자 노드: 그레이디언트 맵"){width="200px"}
...
![그레이디언트 편집기](gradient-map.resources/gradient-map-02.png "그레이디언트 편집기")
...
![그레이디언트 편집기 - 그레이디언트 보기](gradient-map.resources/gradient-map-03.png "그레이디언트 편집기 - 그레이디언트 보기")
...
![그레이디언트 편집기 - 핀 추가](gradient-map.resources/gradient-map-04.gif "그레이디언트 편집기 - 핀 추가")
...
![그레이디언트 편집기 - 핀 위치 매개 변수](gradient-map.resources/gradient-map-05.png "그레이디언트 편집기 - 핀 위치 매개 변수")

</td>
<td style="border: 0;" valign="top">

![그레이디언트 편집기 - 이동 핀](gradient-map.resources/gradient-map-06.gif "그레이디언트 편집기 - 이동 핀")
...
![그레이디언트 편집기 - 핀 삭제](gradient-map.resources/gradient-map-07.gif "그레이디언트 편집기 - 핀 삭제")
...
![그레이디언트 편집기: 위치 반전](gradient-map.resources/gradient-map-08.gif "그레이디언트 편집기: 위치 반전")
...
![그레이디언트 편집기 - 모두 지우기](gradient-map.resources/gradient-map-09.gif "그레이디언트 편집기 - 모두 지우기")
...
![그라디언트 편집기 - 색상 피커](gradient-map.resources/gradient-map-10.png "그라디언트 편집기 - 색상 피커")
...
* <b>그레이디언트 및 색조 막대</b>
  ...
  ![색상 피커 - 그라디언트 영역 및 색조 막대](gradient-map.resources/gradient-map-11.gif "색상 피커 - 그라디언트 영역 및 색조 막대")
...
* <b>RGB, HSV 및 Alpha 슬라이더</b>
  ...
  ![색상 피커 - RGB, HSV 및 Alpha 슬라이더](gradient-map.resources/gradient-map-12.png "색상 피커 - RGB, HSV 및 Alpha 슬라이더")
...
* <b>화면에서 선택</b>
  ...
  ![색상 피커 - 화면에서 선택](gradient-map.resources/gradient-map-13.gif "색상 피커 - 화면에서 선택")
...
![색상 피커 - 색상 되돌리기](gradient-map.resources/gradient-map-14.png "색상 피커 - 색상 되돌리기")
...
![색상 피커 - 단추](gradient-map.resources/gradient-map-15.gif "색상 피커 - 단추")
...
![그레이디언트 편집기 - 그레이디언트 선택기](gradient-map.resources/gradient-map-16.gif "그레이디언트 편집기 - 그레이디언트 선택기")
