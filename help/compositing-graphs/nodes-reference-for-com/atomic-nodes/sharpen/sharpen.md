...
![선명 효과 노드 아이콘](sharpen.resources/sharpen-4.png "선명 효과 노드 아이콘"){width="20%"}
...
선명 효과 노드는 입력에 대해 선명 효과 작업을 수행합니다. 이미지에 선명한 느낌을 마지막으로 적용하기 위한 유용한 노드입니다.

</td>
</tr>
</table>

<div data-preserve-html="true" style="display: block; margin: auto;"><img src="sharpen.resources/sharpen-tooltip.gif" alt="선명 효과 도구 설명" /></div>
...
<b>강도</b> *부동*\
선명하게 하기 효과의 강도를 설정합니다.

<b>펀치스루 Alpha</b> *부울*(색상 이미지가 <b>입력</b>에 연결된 경우 사용 가능)\
이미지의 알파 채널을 선명하게 할지, 아니면 그대로 유지할지 결정합니다.
