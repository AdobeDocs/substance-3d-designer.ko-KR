...
![Atomic node: 픽셀 프로세서](pixel-processor.resources/comp_pixelprocessor_1.png "Atomic node: 픽셀 프로세서"){width="20%"}
...
이 픽셀 프로세서를 사용하면 선택적 입력에서 출력으로 반환되는 모든 픽셀에 대해 사용자 정의 함수를 실행할 수 있습니다.
...
<div data-preserve-html="true" style="display: block; margin: auto;"><img src="pixel-processor.resources/pixel-processor-tooltip.gif" alt="픽셀 프로세서 툴팁" /></div>
...
픽셀 프로세서는 단일 값에서만 실행되며 픽셀 프로세서에 비해 최적화를 제공할 수 있는 [값 프로세서](../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/value-processor/value-processor.md)과(와) 유사합니다.

노드 기반 편집기에서 [셰이더](../../../../glossary/glossary.md) 함수를 만드는 데 사용되는 모든 사용자의 경우 픽셀 프로세서에서 익숙한 환경을 제공해야 합니다.


>[!TIP]
>
> 이 설명서의 [샘플 Substance 그래프](../../../../compositing-graphs/sample-compositing-graphs/sample-substance-compositing-graphs.md) 섹션에서 픽셀 프로세서 노드의 간단한 사용을 보여 주는 주석이 달린 프로젝트 파일을 사용할 수 있습니다.
> 
