...
![Atomic node: 출력](output.resources/comp_output_1.png "Atomic node: 출력")
...
<div data-preserve-html="true" style="text-align: center;"><img src="output.resources/output-tooltip.gif" alt="출력 도구 설명" /></div>
