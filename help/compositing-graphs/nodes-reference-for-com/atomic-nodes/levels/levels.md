...
<div data-preserve-html="true" align="center"><img src="levels.resources/levels-tooltip.gif" alt="레벨 도구 설명" /></div>
...
| <b>수평 아웃 낮음</b> *부동/부동4* | 출력 이미지의 저조도 레벨을 정의합니다.  검정 값 설정 |
