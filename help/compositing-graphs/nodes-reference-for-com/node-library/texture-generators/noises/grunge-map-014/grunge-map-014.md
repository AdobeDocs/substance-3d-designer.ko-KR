...
breadcrumb-title: ""
description: 그런지 맵 014 노드를 사용하면 표면에 디테일과 마모 효과를 더하는 절차 그런지 텍스처를 만들 수 있습니다.
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-map-014.resources/grungemap-014-ex.gif" class="modal-image" alt="그런지 맵 014 - 예제 1" />
        </td>
