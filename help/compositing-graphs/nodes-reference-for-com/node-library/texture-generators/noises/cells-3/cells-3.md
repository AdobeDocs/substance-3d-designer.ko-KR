...
![셀 3 - 아이콘](../../../../../../assets/cells_3.png "셀 3 - 아이콘"){width="200px"}
...
| <b>경도</b> 부동 | 값이 높을수록 벽이 더 선명해지고 선명해집니다. |
| <b>반전</b> 부울 | 이미지 출력의 회색 음영 값을 반전합니다. |
...
| <b>패턴 크기</b> 부동 소수점2 | 셀에 있는 분산 디스크의 크기에 대한 승수입니다. 여기서 1.0은 셀의 전체 범위입니다. |
| <b>패턴 크기 조절</b> 부동 | <b>패턴 크기</b>에 대한 승수입니다. 여기서 1.0은 전체 크기입니다. |
| <b>각도</b> 부동 | 디스크의 방향을 설정할 때 사용된 각도로, 회전 수로, 수평 오른쪽부터 시작하여 설정합니다. |
...
![셀 3 - 예 1](../../../../../../assets/cells_3_1.png "셀 3 - 예 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![셀 3 - 예 2](../../../../../../assets/noise_cells_3_v2_speed0.6_aniso0.gif "셀 3 - 예 2"){zoomable="yes"}
...
![셀 3 - 예 3](../../../../../../assets/noise_cells_3_v2_speed0.6_aniso1.gif "셀 3 - 예 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![셀 3 - 예 4](../../../../../../assets/noise_cells_3_v2_speed0.3_aniso0.6.gif "셀 3 - 예 4"){zoomable="yes"}
