...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="perlin-noise.resources/perlin_noise_1.png" class="modal-image" alt="Perlin 노이즈 - 예제 1" />
        </td>
        <td style="border: 0;">
            <img src="perlin-noise.resources/noise_perlin_noise_v2_speed0.6_aniso0.gif" class="modal-image" alt="Perlin 노이즈 - 예제 2" />
        </td>
