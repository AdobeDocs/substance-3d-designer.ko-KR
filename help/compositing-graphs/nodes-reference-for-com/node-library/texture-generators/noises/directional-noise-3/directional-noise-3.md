...
breadcrumb-title: ''
description: 방향 노이즈 3 노드를 사용하면 직접 텍스처를 만들기 위한 세 옥타브가 있는 방향 노이즈 패턴을 생성할 수 있습니다.
...
![방향 노이즈 3 - 아이콘](directional-noise-3.resources/directional_noise_3.png "방향 노이즈 3 - 아이콘"){width="200px"}
...
![방향 노이즈 3 - 예 1](directional-noise-3.resources/directional_noise_3_1.png "방향 노이즈 3 - 예 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![방향 노이즈 3 - 예 2](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso0.gif "방향 노이즈 3 - 예 2"){zoomable="yes"}
...
![방향 노이즈 3 - 예 3](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.6_aniso1.gif "방향 노이즈 3 - 예 3"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![방향 노이즈 3 - 예 4](directional-noise-3.resources/noise_directional_noise_3_v2_speed0.3_aniso0.6.gif "방향 노이즈 3 - 예 4"){zoomable="yes"}
