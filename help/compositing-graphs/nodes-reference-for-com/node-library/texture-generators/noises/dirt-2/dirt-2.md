---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/dirt-2.html"
breadcrumb-title: ""
description: Dirt 2 노드를 사용하여 풍화된 표면 세부 사항과 축적 효과를 만들기 위한 기본 Dirt 패턴을 생성합니다.
...
![Dirt 2 - 아이콘](dirt-2.resources/dirt_2.png "Dirt 2 - 아이콘"){width="200px"}
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/dirt_2_1.png" class="modal-image" alt="Dirt 2 - 예제 1" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso0.gif" class="modal-image" alt="Dirt 2 - 예제 2" />
        </td>
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.6_aniso1.gif" class="modal-image" alt="Dirt 2 - 예제 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="dirt-2.resources/noise_dirt_2_v2_speed0.3_aniso0.6.gif" class="modal-image" alt="Dirt 2 - 예제 4" />
        </td>
