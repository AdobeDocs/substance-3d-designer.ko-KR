...
| <b>최대 진폭</b>  부동 | 파형의 최대값(또는 Thickness)입니다. |
| <b>노이즈</b> 부동 | 파형의 세로 범위에서 임의로 제거하는 파형에 노이즈를 적용합니다. |
| <b>위치</b> 정수 | 이미지의 파형 위치:<ul data-preserve-html="true"> <li data-preserve-html="true"><i>가운데:</i> 원점은 이미지의 세로 중앙에 있습니다</li> <li data-preserve-html="true"><i>아래쪽:</i> 원점은 이미지의 아래쪽입니다</li> </ul> |
| <b>패턴</b> 정수 | 파형의 각 샘플에 배치된 패턴입니다. |
| <b>패턴 변형</b> 부동 | 일부 패턴에 사용할 수 있는 추가 조정입니다. |
| <b>장애</b> 부동 | 파형 값을 변위합니다.    이 효과를 사용하여 애니메이션을 적용할 수 있습니다. |
| <b>장애 속도</b> 부동 | <b>Disorder</b> 매개 변수에 의해 적용된 변위의 거리를 조정합니다.    파형에 애니메이션을 적용할 때 변위 속도를 제어하는 데 사용할 수 있습니다. |
