---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/texture-generators/noises/fractal-sum-2.html"
breadcrumb-title: ''
description: 프랙탈 합산 2 노드를 사용하여 두 옥타브가 있는 프랙탈 노이즈를 생성하여 유기적인 텍스처 변형을 생성합니다.
...
![프랙탈 합산 2 - 아이콘](fractal-sum-2.resources/fractal-sum-2-01.png "프랙탈 합산 2 - 아이콘"){width="200px"}
...
![프랙탈 합산 2 - 예 1](fractal-sum-2.resources/fractal-sum-2-02.png "프랙탈 합산 2 - 예 1"){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![프랙탈 합산 2 - 예 2](fractal-sum-2.resources/fractal-sum-2-03.gif "프랙탈 합산 2 - 예 2"){zoomable="yes"}
