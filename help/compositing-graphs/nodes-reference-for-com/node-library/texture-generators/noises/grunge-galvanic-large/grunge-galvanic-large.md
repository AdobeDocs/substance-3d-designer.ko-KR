...
**그런지 대형** 노드는 아연 도금 강철의 패턴과 유사한 그런지 맵을 생성합니다.
...
| <b>고급</b> |  |
| <b>뒤틀기 강도</b> <i>부동</i> | 기본 뒤틀기 효과의 강도를 조정합니다. |
| <b>릿지 세부 정보 불투명도</b> <i>부동</i> | 밝은 융기의 불투명도를 조정합니다. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant.jpg" class="modal-image" alt="그런지 갈바닉 라지 - 예제 1" />
        </td>
        <td style="border: 0;">
            <img src="grunge-galvanic-large.resources/grungegalvaniclarge-variant2.jpg" class="modal-image" alt="그런지 갈바닉 라지 - 예제 2" />
        </td>
