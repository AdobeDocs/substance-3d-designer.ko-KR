...
![방향 스크래치 - 아이콘](directional-scratches.resources/directional_scratches.png "방향 스크래치 - 아이콘"){width="200px"}
...
| <b>패턴 크기</b> <i>부동2</i> | 스크래치 패턴에 대한 테두리 상자의 크기입니다.    Y 값은 스크래치의 최대 길이를 제어합니다. |
| <b>패턴 크기 무작위</b> <i>부동2</i> | 스크래치에 적용되는 임의 다운스케일링 양에 대한 승수입니다.    Y 값은 해당 스크래치 길이에 적용됩니다. |
...
<table style="table-layout:fixed">
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="directional-scratches.resources/directional_scratches_1.png" class="modal-image" alt="직접 스크래치 - 예제 1" />
        </td>
        <td style="border: 0;">
            <img src="directional-scratches.resources/noise-directional-scratches-speed0.3-aniso0.gif" class="modal-image" alt="직접 스크래치 - 예제 2" />
        </td>
        <td style="border: 0;">
            <img src="directional-scratches.resources/noise-directional-scratches-speed0.3-aniso0.6.gif" class="modal-image" alt="직접 스크래치 - 예제 3" />
        </td>
    </tr>
    <tr style="border: 0;">
        <td style="border: 0;">
            <img src="directional-scratches.resources/noise-directional-scrat-1.gif" class="modal-image" alt="직접 스크래치 - 예제 4" />
        </td>
        <td style="border: 0;">
            <img src="directional-scratches.resources/noise-directional-scrat-2.gif" class="modal-image" alt="직접 스크래치 - 예제 5" />
        </td>
