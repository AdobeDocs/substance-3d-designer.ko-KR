...
| <b>출력</b> <i>이진 마스크, 정수 마스크, 회색 음영 값</i> | 출력 값의 유형을 결정합니다. [이진 마스크]는 흑백, 0 또는 1 값만 반환합니다. [정수 마스크]는 HDR 형식의 각 패턴에 대해 최대 8까지의 높은 값을 인코딩하고, [회색 음영 값]은 0과 1 사이에 비례적으로 범위를 분산합니다. |
