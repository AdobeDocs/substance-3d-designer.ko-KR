...
| <b>벡터 맵 변위</b> *부동* | <b>벡터 맵</b> 입력의 *샘플링* 값을 사용하여 각 정점에 적용되는 *전역* 변위 양을 조정합니다.    이 오프셋은 <b>무작위 위치</b> 및 <b>Quinux 오프셋</b> 매개 변수와 함께 *스택*&#x200B;입니다. |
...
| <b>회전 장애</b> *부동* | *기본 위치*&#x200B;를 중심으로 각 정점에 *임의* 회전량을 적용합니다(즉, 임의 오프셋 및 변위가 적용되기 *전* 위치).    이 회전 *스택*&#x200B;은 <b>회전</b> 매개 변수와 함께 사용됩니다. |
| <b>Height 입력 승수</b> *부동* | <b>Height</b> 입력의 *샘플링* 값을 사용하여 각 정점의 Z 위치를 조정합니다.    이 오프셋은 <b>Height 무작위</b> 매개 변수와 함께 *스택*&#x200B;입니다. |
