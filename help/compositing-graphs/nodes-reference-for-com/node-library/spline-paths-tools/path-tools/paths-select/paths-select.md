...
![노드 아이콘](../../../../../../assets/paths-select-icon.png "노드 아이콘")
...
<b>경로 ID</b> *정수*(<b>선택 모드</b>가 *ID별*(으)로 설정된 경우 사용 가능)\
선택한 패스의 인덱스입니다.\
