...
<b>Start Random Offset</b> *Float*&#x200B;브리지 스플라인의 시작 위치에 적용된 무작위 오프셋에 대한 승수입니다. 여기서 최대 거리는 <b>Random offset range</b> 매개 변수에 의해 지정됩니다.

<b>End Random Offset</b> *Float*&#x200B;브리지 스플라인의 끝 위치에 적용된 무작위 오프셋에 대한 승수입니다. 여기서 최대 거리는 <b>Random offset range</b> 매개 변수에 의해 지정됩니다.

<b>전역 임의 오프셋</b> *부동*&#x200B;브리지 스플라인의 시작 위치와 끝 위치 *모두*&#x200B;에 적용되는 임의 오프셋의 *같은 양*&#x200B;에 대한 승수입니다. 여기서 최대 거리는 <b>임의 오프셋 범위</b> 매개 변수에 의해 지정됩니다.
...
<b>Thickness 무작위</b> *부동*&#x200B;브리지 스플라인의 Thickness에 대한 무작위 승수입니다. 여기서 이 승수가 적용되는 초기 Thickness은 <b>Thickness 모드</b> 매개 변수에 의해 지정됩니다.

+++

+++높이
<b>Height 모드</b> *정수*&#x200B;브리지 스플라인의 Height 값을 가져오는 방법입니다.\
...
<b>Height 무작위</b> *부동*&#x200B;브리지 스플라인의 Height에 대한 무작위 조정 양입니다. 여기서 해당 조정은 선택한 <b>Height 모드</b> 매개 변수에 따라 달라집니다.\
