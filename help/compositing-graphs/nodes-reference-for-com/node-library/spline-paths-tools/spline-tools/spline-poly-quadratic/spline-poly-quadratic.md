...
![노드 아이콘](spline-poly-quadratic.resources/spline-poly-quadratic-01.png "노드 아이콘")
...
| <b>포인트 미리 보기</b> <i>회색 음영</i> | 점을 회색 음영 이미지로 미리 봅니다. |
| <b>입력 지점 목록</b> <i>색상</i> | (입력 지점 목록 사용이 True인 경우 사용 가능) 색상 이미지의 RGBA 채널로 인코딩된 지점 목록:<br><b>R</b> - X 위치<br><b>G</b> - Y 위치<br><b>B</b> - Height<br><b>A</b> - 압축된 데이터:<br> - 정수 부분: Smoothness;<br> - 분수 부분: Thickness. |
| <b>지점 번호</b> <i>정수</i> | (&#39;입력 지점 목록 사용&#39;이 True일 때 사용 가능) 지점 수입니다. |
...
|  |  |
|:---|:---|
| <b>포인트 양</b> <i>정수</i> | 스플라인을 만드는 데 사용되는 임의의 포인트 수입니다. |
| <b>스플라인 연결 모드 입력</b> <i>정수</i> | 입력 스플라인을 연결하는 데 사용되는 방법:<br>- <i>자동:</i> 마지막 입력 스플라인의 끝은 생성된 스플라인의 시작에 연결되고 생성된 스플라인의 끝은 첫 번째 입력 스플라인의 시작에 연결됩니다.<br>- <i>수동:</i> 생성된 스플라인의 가장자리에 연결할 입력 스플라인을 지정할 수 있으며 입력 스플라인에서 이 연결이 착륙할 위치를 지정할 수 있습니다. |
| <b>스플라인 닫기</b> <i>부울</i> | 스플라인의 끝점을 시작점에 연결할지 여부를 제어합니다.<br>시작점 및 끝점의 스플라인에 적용된 매끄러움은 해당 점의 Smoothness 값으로 지정됩니다. |
| <b>방향 뒤집기</b> <i>부울</i> | 스플라인의 방향을 반전합니다. |
| <b>입력 지점 목록 사용</b> <i>부울</i> | 임의의 포인트 목록 대신 [입력 포인트 목록] 및 [포인트 번호] 입력 커넥터에 제공된 포인트 목록을 사용합니다.<br>포인트 목록은 [포인트 목록](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/point-list/point-list.md) 노드에서 제공할 수 있습니다. |
| <b>시작 부분을 입력 스플라인에 연결</b> <i>부울</i> | True이면 생성된 스플라인의 시작점이 입력 스플라인의 마지막 스플라인의 마지막 점에 연결됩니다. |
| <b>연결 스플라인 인덱스 시작</b> <i>정수</i> | (&#39;입력 스플라인 연결 모드&#39;가 &#39;수동&#39;으로 설정되고 &#39;입력 스플라인에 시작 연결&#39;이 &#39;참&#39;으로 설정된 경우 사용 가능) 생성된 스플라인의 시작과 연결해야 하는 입력 스플라인의 인덱스입니다. |
| <b>연결 위치 시작</b> <i>부동</i> | (&#39;입력 스플라인 연결 모드&#39;가 &#39;수동&#39;으로 설정되고 &#39;입력 스플라인에 시작 연결&#39;이 &#39;참&#39;으로 설정된 경우 사용 가능) 생성된 스플라인의 시작에 대한 연결이 해제되어야 하는 선택한 입력 스플라인의 위치입니다.<br>이 값은 선택한 입력 스플라인의 정규화된 길이입니다. |
| <b>입력 스플라인에 끝 연결</b> <i>부울</i> | True이면 생성된 스플라인의 끝이 입력 스플라인의 첫 번째 스플라인의 첫 번째 점에 연결됩니다. |
| <b>연결 스플라인 인덱스 종료</b> <i>정수</i> | (&#39;입력 스플라인 연결 모드&#39;를 &#39;수동&#39;으로, &#39;입력 스플라인에 끝 연결&#39;을 &#39;참&#39;으로 설정한 경우 사용 가능) 생성된 스플라인의 끝에 연결해야 하는 입력 스플라인의 인덱스입니다. |
| <b>연결 위치 종료</b> <i>부동</i> | (&#39;입력 스플라인 연결 모드&#39;가 &#39;수동&#39;으로 설정되고 &#39;입력 스플라인에 끝 연결&#39;이 &#39;참&#39;으로 설정된 경우 사용 가능) 생성된 스플라인의 끝에 대한 연결이 해제되어야 하는 선택한 입력 스플라인의 위치입니다.<br>이 값은 선택한 입력 스플라인의 정규화된 길이입니다. |
...
| <b>미리 보기</b> |  |
| <b>접선 표시</b> <i>부울</i> | 미리 보기 출력에서 p1 및 p3 지점의 접선을 p2에 표시합니다. |
...
| <b>포인트 레이블 표시</b> <i>부울</i> | 각 점에 대해 &#39;미리 보기&#39; 출력에서 해당 점 옆에 점의 이름을 표시합니다. |
| <b>포인트 레이블 크기</b> <i>부동</i> | (&#39;포인트 레이블 표시&#39;가 &#39;True&#39;로 설정된 경우 사용 가능) 텍스처 공간의 각 포인트에 대한 레이블 크기입니다. 여기서 0.1은 텍스처 너비의 10분의 1입니다. |
| <b>포인트 표시</b> <i>부울</i> | 스플라인의 조절점을 표시합니다. |
| <b>포인트 크기</b> <i>부동</i> | (&#39;포인트 표시&#39;가 &#39;참&#39;으로 설정된 경우 사용 가능) 텍스처 공간에서 포인트의 반경입니다. 여기서 0.1은 텍스처 폭의 10분의 1입니다. |
...
![노드 예 2](spline-poly-quadratic.resources/spline-poly-quadratic-04.gif "노드 예 2")
