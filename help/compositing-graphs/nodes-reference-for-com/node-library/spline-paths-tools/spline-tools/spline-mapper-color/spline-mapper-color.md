...
![노드 아이콘](spline-mapper-color.resources/spline-mapper-color-01.png "노드 아이콘")
...
노드는 매핑된 이미지를 컬러 이미지뿐만 아니라 Height, UV(즉, 이미지 좌표), 매핑된 각 스플라인을 독립적으로 선택하기 위한 ID 마스크 등의 기타 정보로 출력한다.
...
>[!NOTE]
>
> [스플라인 매퍼 회색 음영](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/spline-paths-tools/spline-tools/spline-mapper-grayscale/spline-mapper-grayscale.md)을 참조하세요.
...
|  |  |
|:---|:---|
| <b>색상</b> <i>색상</i> | 입력 스플라인에 걸쳐 입력 색상 이미지를 색상 이미지로 매핑한 결과입니다. |
...
![노드 예 2](spline-mapper-color.resources/spline-mapper-color-04.gif "노드 예 2")
...
![노드 예 3](spline-mapper-color.resources/spline-mapper-color-05.jpg "노드 예 3")
