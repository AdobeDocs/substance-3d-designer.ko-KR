...
<b>Thickness 맵</b> *회색 음영*&#x200B;입력 스플라인의 Thickness을 변경하는 데 사용되는 입력 회색 음영 이미지입니다.
...
<b>샘플링 모드</b> *정수* Thickness 맵의 값을 스플라인에 매핑하는 방법:\
...
<b>불투명도</b> *부동*&#x200B;스플라인 Thickness에 대한 Thickness 맵 입력의 기여도 강도에 대한 승수입니다.<b></b>

<b>혼합 모드</b> *정수* Thickness 맵의 데이터를 입력 스플라인의 <span id="_Hlk135820484"></span>Thickness과 혼합하는 방법:\
*- 복사*: 스플라인의 Thickness을 Height 맵 값으로 재정의합니다.\
*- 추가*: 스플라인의 Thickness에 Thickness 맵 값을 추가합니다.\
*- 빼기*: Thickness 맵 값을 스플라인의 Thickness에 뺍니다.\
*- 곱하기*: 스플라인의 Thickness에 대해 Thickness 맵 값을 곱합니다.
