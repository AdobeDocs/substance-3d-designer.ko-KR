...
breadcrumb-title: ''
description: UV 매퍼 회색 음영 노드를 사용하여 절차 텍스처 생성을 위해 스플라인을 따라 회색 음영 텍스처를 매핑합니다.
...
<b>입력</b> *색상* UV 입력에 제공된 좌표에 매핑할 회색 음영 이미지입니다.

## 출력 커넥터

<b>출력</b> *색상*&#x200B;입력 UV 좌표를 사용하여 입력 이미지를 회색 음영 이미지로 매핑한 결과입니다.
