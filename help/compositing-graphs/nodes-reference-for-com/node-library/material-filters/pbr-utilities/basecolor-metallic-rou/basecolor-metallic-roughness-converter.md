...
이 노드는 [기준 색상], [금속 색상] 및 [거칠기] 맵을 Specular/광택도 모델과 같은 다른 PBR 모델 출력으로 변환합니다. 포함된 출력 대상 중 일부는 Vray, Corona, Redshift, Renderman 및 Arnold와 같은 잘 알려진 렌더링 엔진입니다.
