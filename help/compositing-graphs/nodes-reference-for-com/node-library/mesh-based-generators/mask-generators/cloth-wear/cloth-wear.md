---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/mesh-based-generators/mask-generators/cloth-wear.html"
breadcrumb-title: ''
...
* **천 Height**: *회색 음영 입력*\
  천 패턴 전용 Height. 이것은 (구운) 오브젝트의 Height이 아니라 타일링 세부 패턴입니다.
* **마스크(선택 사항)**: *회색 음영 입력*\
  노드의 효과를 마스킹하는 데 사용되는 마스크 슬롯입니다.
* **곡률**: *회색 음영 입력*\
  구겨진/생성된 곡률로 솟아오른 모서리를 결정합니다.

### 매개변수

* **하드 에지 양**: *0.0 - 1.0*
* **마모 부드러움**: *0.0 - 5.0*&#x200B;마모된 가장자리가 얼마나 흐려지거나 부드러운지를 결정합니다.
