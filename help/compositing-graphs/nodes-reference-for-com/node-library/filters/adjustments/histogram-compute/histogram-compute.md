...
|  |  |
|:---|:---|
| <b>입력</b> <i>회색 음영</i> 기본 | 히스토그램을 계산할 이미지입니다. |
...
|  |  |
|:---|:---|
| <b>막대 그래프</b> <i>회색 음영</i> | 입력 이미지에 대해 계산된 막대 그래프로, 각 픽셀 값이 X축의 픽셀 위치와 일치하는 색상 값의 *모집단*&#x200B;인 픽셀 행으로 인코딩됩니다.   예를 들어, (0.25, 0)에서 75의 픽셀 값은 이미지에 0.25 색상 값을 갖는 75개의 픽셀이 있음을 의미합니다. |
| <b>CDF</b> <i>회색 음영</i> | 이미지에 대해 계산한 *누적 분포 함수*(CDF)의 결과로, 픽셀 행으로 인코딩됩니다. 여기서 각 픽셀은 왼쪽에 있는 모든 픽셀 값의 합계입니다.   그 합계는 이미지의 총 픽셀 수에 대해 *정규화*&#x200B;됩니다. |
