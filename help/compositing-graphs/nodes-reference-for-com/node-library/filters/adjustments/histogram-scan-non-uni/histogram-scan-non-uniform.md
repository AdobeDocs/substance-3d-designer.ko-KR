...
* **입력**: *회색 음영 입력*&#x200B;수정할 원본 결과.
* **위치 맵**: *회색 음영 입력*&#x200B;위치 매개 변수를 제어하는 입력 슬롯. &quot;위치 입력 사용&quot;이 True로 설정된 경우 활성화됩니다. 유효 값 범위는 작으며 대비 맵과 설정에 따라 다릅니다.
* **대비 맵**: *회색 음영 입력*&#x200B;대비 매개 변수를 구동하기 위한 입력 슬롯. &quot;대비 입력 사용&quot;이 True로 설정된 경우 활성화됩니다. 유효 값 범위가 작습니다.

### 매개변수

* **위치 입력 사용**: *False/True*&#x200B;위치 맵 입력 슬롯 사용 전환.
* **위치**: *0.0 - 1.0*&#x200B;지도 결과를 제어하거나 수정하여 위치 설정을 제어합니다.
* **대비 입력 사용**: *False/True*&#x200B;대비 맵 입력 슬롯 사용을 전환합니다.
* **대비**: *0.0 - 1.0*&#x200B;맵 결과를 제어하거나 수정하여 대비 설정을 조정합니다.
