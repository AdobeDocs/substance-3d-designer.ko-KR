...
|  |  |
|:---|:---|
| <b>ID</b> <i>회색 음영</i> 기본 | 입력 팔레트의 색상을 분배하는 데 사용되는 입력 ID 맵입니다.   ID 맵은 전체(예를 들어, 모양)의 일부인 픽셀들이 모두 동일한 고유 식별 값을 갖는 이미지이다. 이 경우 값은 정수입니다.   [색상 정량화](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/adjustments/quantize-color/quantize-color.md) 노드를 사용하여 ID 맵을 생성할 수 있습니다. |
...
|  |  |
|:---|:---|
| <b>출력</b> <i>색상</i> | 팔레트의 색상을 ID 맵의 색인에 매핑한 결과입니다. |
