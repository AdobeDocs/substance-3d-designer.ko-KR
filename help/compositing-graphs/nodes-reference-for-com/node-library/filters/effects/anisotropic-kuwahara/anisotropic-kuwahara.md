...
| <b>비등방성 각도 맵 멀티플라이어</b> *Float* *&#39;입력 방향 맵 사용&#39;이 &#39;False&#39;로 설정된 경우 사용 가능* | &#39;비등방성 각도 맵&#39; 입력의 값 강도를 조정합니다. 이 값은 방향 맵에 적용된 회전 위에 회수로 추가됩니다.   이 추가 회전은 &#39;비등방성 각도&#39; 매개 변수에 지정된 것과 함께 *누적*&#x200B;입니다. |
