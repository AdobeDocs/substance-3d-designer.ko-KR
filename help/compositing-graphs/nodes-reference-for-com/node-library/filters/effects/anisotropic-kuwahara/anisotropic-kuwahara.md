...
|  |  |
|:---|:---|
| <b>입력</b> 기본 <i>색상</i> | 처리해야 하는 색상 이미지입니다. |
...
| <b>텐서 Smoothness</b> *부동* *&#39;입력 방향 맵 사용&#39;이 &#39;False&#39;로 설정된 경우 사용 가능* | 이미지에서 계산되어 방향 맵에 저장된 방향에 적용되는 흐림 효과의 강도를 조정합니다.   이 값을 높이면 이미지의 세부 묘사가 고주파인 경우 더 매끄러운 결과가 나옵니다. |
| <b>비등방성 각도</b> *부동* *&#39;입력 방향 맵 사용&#39;이 &#39;False&#39;로 설정된 경우 사용 가능* | 회전 수로 방향 맵에 회전을 추가합니다.   이 추가 순환은 &#39;비등방성 각도 맵&#39; 입력에 지정된 것과 함께 *누적*&#x200B;입니다. |
| <b>비등방성 각도 맵 멀티플라이어</b> *부동* *&#39;입력 방향 맵 사용&#39;이 &#39;False&#39;로 설정된 경우 사용 가능* | &#39;비등방성 각도 맵&#39; 입력의 값 강도를 조정합니다. 이 값은 방향 맵에 적용된 회전 위에 회수로 추가됩니다.   이 추가 회전은 &#39;비등방성 각도&#39; 매개 변수에 지정된 것과 함께 *누적*&#x200B;입니다. |
