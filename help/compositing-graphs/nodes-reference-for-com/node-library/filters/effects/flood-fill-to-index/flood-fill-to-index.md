...
또한 색인에 Flood Fill은 새로운 [값 시스템을 사용하여 발견된 모양의 양과 선택적 내부 데이터 테이블을 포함하는 추가 값](https://helpx.adobe.com/substance-3d/unlisted/documentation/sddoc/values-in-substance-3d-graphs-180192235.html)을 반환합니다.
