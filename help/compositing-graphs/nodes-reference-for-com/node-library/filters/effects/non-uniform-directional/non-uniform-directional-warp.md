...
* **뒤틀기 각도 입력**: *회색 음영 입력*\
  뒤틀기 효과의 [각도]를 제어하는 필수 마스크 맵은 회색 음영이어야 합니다.
...
* **뒤틀기 각도 입력 승수**: *0.0 - 1.0*\
  [뒤틀기 각도] 입력 맵의 효과를 설정합니다. 뒤틀기 각도 입력 맵은 0부터 이 매개 변수 값까지 보간하는 데 사용됩니다.
* **트레일 모드**: *최소, 최대, 평균*\
  트레일 혼합 방식을 설정합니다.
* **트레일 길이**: *0.0 - 1.0*\
  트레일 길이를 설정합니다.
* **트랙 페이드**: *0.0 - 1.0*\
  각 Trail이 페이드 아웃되는 양을 설정합니다.
* **트레일 곡선**: *-1.0 - 1.0*&#x200B;트레일 페이드가 0이 아닌 경우에만 적용됩니다. 페이드 효과의 작동 방식을 설정합니다.
