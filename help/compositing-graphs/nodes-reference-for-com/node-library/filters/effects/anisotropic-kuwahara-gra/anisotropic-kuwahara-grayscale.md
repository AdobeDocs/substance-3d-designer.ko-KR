---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-designer/substance-compositing-graphs/nodes-reference-for-substance-compositing-graphs/node-library/filters/effects/anisotropic-kuwahara-grayscale.html"
breadcrumb-title: ''
description: '[비등방성 구와하라 회색 음영] 필터를 사용하여 직접 매끄럽게 하는 스타일화된 회화적인 효과를 만들 수 있습니다.'
...
![비등방성 구와하라 회색 음영 아이콘](https://helpx.adobe.com/content/dam/substance-3d-designer/substance-graphs/nodes/filters/effects/anisotropic-kuwahara/AnisotropicKuwaharaGrayscale.png "비등방성 구와하라 회색 음영 아이콘"){width="200px"}
...
![비등방성 0이 적용된 쿠와하라 필터가 있는 과일 그릇.](https://helpx.adobe.com/content/dam/substance-3d-designer/substance-graphs/nodes/filters/effects/anisotropic-kuwahara/anisotropic_kuwahara_gray_example_3_before.jpg){zoomable="yes"}

</td>
<td style="border: 0;" valign="top">

![비등방성 0이 적용된 쿠와하라 필터가 있는 과일 그릇.](https://helpx.adobe.com/content/dam/substance-3d-designer/substance-graphs/nodes/filters/effects/anisotropic-kuwahara/anisotropic_kuwahara_gray_example_3_after.jpg){zoomable="yes"}
...
|  |  |
|:---|:---|
| <b>입력</b> <i>회색 음영</i> <b>기본</b> | 처리해야 하는 회색 음영 이미지입니다. |
...
|  |  |
|:---|:---|
| <b>출력</b> <i>회색 음영</i> | 노드가 입력 이미지에 적용한 비등방성 흐림 효과의 결과입니다. |
