...
breadcrumb-title: ''
description: Blur HQ 노드를 사용하여 텍스처에 고품질 흐림 효과를 적용하여 매끄럽고 전문적인 흐림 효과를 만들 수 있습니다.
...
* **강도**: *0.0 - 16.0*\
  흐림 효과의 강도(반경)입니다. 이 값이 높을수록 흐림 효과가 더 적용됩니다.
* **품질**: *0 - 1*&#x200B;낮은 계산 속도에서 더 높은 품질의 내부 샘플링 양을 증가시킵니다.
