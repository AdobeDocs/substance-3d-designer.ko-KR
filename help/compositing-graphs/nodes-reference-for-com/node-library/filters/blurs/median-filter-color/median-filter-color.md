...
|  |  |
|:---|:---|
| <b>입력</b> <i>색상</i> | 필터를 적용해야 하는 색상 이미지입니다. |
...
|  |  |
|:---|:---|
| <b>출력</b> <i>색상</i> | 입력 색상 이미지에 필터를 적용하여 계산된 색상 이미지입니다. |
...
| <b>알파 영향</b> *부울* | 이미지의 알파 채널에 필터를 적용할지 여부를 제어합니다. *True*&#x200B;인 경우 알파 채널이 변경되지 않습니다. |
