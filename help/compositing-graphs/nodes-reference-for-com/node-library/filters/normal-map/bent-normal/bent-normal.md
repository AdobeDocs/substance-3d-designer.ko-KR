...
breadcrumb-title: ''
description: 구부러진 표준 노드를 사용하면 앰비언트 오클루전 및 간접 조명을 설명하는 구부러진 노멀 맵을 생성할 수 있습니다.
...
높이 맵 입력을 기반으로 하여 구부러진 노멀 맵을 생성합니다. 구부러진 노멀 맵은 [표준](../../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md) 및 [앰비언트 오클루전(RTAO)](../../../../../../compositing-graphs/nodes-reference-for-com/node-library/filters/effects/ambient-occlusion-rtao/ambient-occlusion-rtao.md)의 특수 버전으로, 포함된 앰비언트 오클루전으로 노멀 맵을 생성합니다.\
이것은 금속에 대한 더 정확한 오클루전 반사를 위해 앰비언트 오클루전을 정규지도에 넣기 위해 실시간 엔진에 사용할 수 있습니다.
...
| <b>물리적 크기</b> <i>부동3</i> | (<b>물리적 크기 사용</b>이(가) <i>True</i>(으)로 설정된 경우 사용 가능) 표면의 실제 물리적 크기를 기준으로 Height 비율을 조정합니다. |
