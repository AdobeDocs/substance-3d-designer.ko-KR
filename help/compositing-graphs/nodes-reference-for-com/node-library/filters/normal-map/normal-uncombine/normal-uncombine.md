...
breadcrumb-title: ''
description: 결합된 노멀 맵 데이터를 개별 X, Y 및 Z 구성 요소로 분리하려면 일반 결합 해제 노드를 사용합니다.
...
![표준 결합 해제 아이콘](../../../../../../assets/NormalUncombine.png "표준 결합 해제 아이콘"){width="200px"}
...
| <b>Height</b> <i>회색 음영</i> | 결합된 노멀 맵에서 제거해야 할 서피스 세부 정보를 나타내는 높이 맵입니다. |
...
|  |  |
|:---|:---|
| <b>결합되지 않은 정상</b> <i>색상</i> | 입력 높이 맵에서 설명하는 표면 세부 정보가 제거된 노멀 맵. |
| <b>추정 강도</b> <i>부동</i> | 입력 노멀 맵의 강도와 일치하도록 입력 높이 맵에 연결된 [표준](../../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md) 노드로 설정되어야 하는 강도 추정치입니다. |
...
|  |  |
|:---|:---|
| <b>일반 형식</b> *정수* | 입력 노멀 맵 형식입니다. 녹색 채널을 효과적으로 반전합니다.<ul data-preserve-html="true"> <li data-preserve-html="true"><b>DirectX:</b> Y축이 위쪽을 가리킵니다.</li> <li data-preserve-html="true"><b>OpenGL:</b> Y축은 아래를 가리킵니다.</li> </ul> |
...
![일반 결합 해제: 예 2](../../../../../../assets/normal_uncombine_example_4.png "일반 결합 해제: 예 2"){zoomable="yes"}
...
![일반 결합 해제: 예 4](../../../../../../assets/normal_uncombine_example_6.png "일반 결합 해제: 예 4"){zoomable="yes"}
...
![일반 결합 해제: 예 6](../../../../../../assets/normal_uncombine_example_5.png "일반 결합 해제: 예 6"){zoomable="yes"}
