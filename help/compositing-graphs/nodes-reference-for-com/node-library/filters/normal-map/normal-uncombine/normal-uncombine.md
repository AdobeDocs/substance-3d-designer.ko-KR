...
|  |  |
| --- | --- |
| <b>결합된 표준</b> 기본 *색상* | 세부 정보를 제거해야 하는 일반 맵입니다. |
| <b>Height</b> *회색 음영* | Height 맵은 결합된 표준 맵에서 제거해야 할 표면 세부 정보를 나타냅니다. |

## 출력 커넥터

|  |  |
| --- | --- |
| <b>결합되지 않은 정상</b> *색상* | 입력 Height 맵에 의해 기술된 표면 세부 정보가 제거된 표준 맵. |
| <b>추정 강도</b> *부동* | 입력 표준 맵의 강도와 일치하도록 입력 Height 맵에 연결된 [표준](../../../../../../compositing-graphs/nodes-reference-for-com/atomic-nodes/normal/normal.md) 노드로 설정되어야 하는 강도의 추정치입니다. |
