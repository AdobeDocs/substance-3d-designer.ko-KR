...
*여러* 2D 보기 패널은 언제든지 활성화할 수 있으며 각각 다른 이미지 또는 값을 표시할 수 있습니다. 사용자 인터페이스 패널의 ![](2d-view.resources/2d-view-icon-pin.png) <b>핀</b> 기능을 사용하여 새 패널을 사용해야 하는 시기를 제어할 수 있습니다.
...
+++클립보드로 복사
![2D 클립보드에 복사](2d-view.resources/2d-view-copy-clipboard.gif "2D 클립보드에 복사"){width="360px"}
...
+++이미지 정보
![2D 이미지 정보 보기](2d-view.resources/2d-view-information.png "2D 이미지 정보 보기"){width="360px"}



![](2d-view.resources/2d-view-icon-information.png) <b>이미지 정보</b> 단추를 사용하여 활성화된 <b>정보</b> 패널을 사용하여 이미지에 *정확한 픽셀 값* *과(와) 좌표*&#x200B;를 표시할 수 있습니다. 이는 예를 들어 HDR 이미지를 검사하거나 픽셀 사이의 단계가 의도된 진행을 따르는지 확인할 때 매우 유용합니다.
...
![2D 보기 비트맵 페인팅 도구](2d-view.resources/2dview-paintingtools-main.png "2D 보기 비트맵 페인팅 도구")
...
![2D 보기 벡터 그래픽 편집기](2d-view.resources/2dview-vectorediting-main.png "2D 보기 벡터 그래픽 편집기")
...
>[!WARNING]
>
> 이러한 *전용* 컨트롤은 *디스플레이 색상 공간*&#x200B;에 영향을 줍니다. 이미지의 *원본 색상 공간*&#x200B;과 *작업 색상 공간*&#x200B;도 고려해야 **2D 보기**&#x200B;에서 색상이 정확하게 표시됩니다.
