...
![2D 보기](../../assets/2d-view-main.png "2D 보기")
...
*여러* 2D 보기 패널은 언제든지 활성화할 수 있으며 각각 다른 이미지 또는 값을 표시할 수 있습니다. 사용자 인터페이스 패널의 ![](../../assets/2d-view-icon-pin.png) <b>핀</b> 기능을 사용하여 새 패널을 사용해야 하는 시기를 제어할 수 있습니다.
...
* <b>뷰포트에 맞게 조정:</b> F / &#39;보기에 맞춤&#39; 버튼 ![](../../assets/2d-view-icon-fit-to-view.png)
* <b>1:1 배율에 조정:</b> Z / &#39;배율에 맞추기&#39; 단추 ![](../../assets/2d-view-icon-fit-to-scale.png)

</td>
<td style="border: 0;" valign="top">

![2D 뷰 뷰포트 탐색](../../assets/2d-view-viewport-navigation.gif "2D 뷰 뷰포트 탐색")
...
* 바둑판식 표시: *바둑판식 패턴으로 뷰포트에서 이미지를 반복합니다*. 이 옵션은 패턴 또는 텍스처가 어떻게 반복되는지 확인할 때 유용합니다. **스페이스바** 또는 ![](../../assets/2d-view-icon-tiling.png) **타일식 표시** 단추를 사용하여 사용할 수 있습니다.
* 물리적 크기 표시: 그래프의 [물리적 크기](../../compositing-graphs/graph-parameters/graph-parameters.md) 속성과 일치하는 *비율*&#x200B;로 이미지를 표시합니다. ![](../../assets/2d-view-icon-physical-size.png) **물리적 크기 비율** 단추를 사용하여 활성화됩니다.
* 보기 크기 유지: 이 옵션은 다른 이미지 전체에서 일관성을 유지하도록 표시 크기를 *잠급니다*. 기본적으로 *활성화됨*&#x200B;이며 ![](../../assets/2d-view-icon-lock-scale.png) **보기 크기 유지** 단추를 사용하여 비활성화할 수 있습니다.
...
+++배경 이미지
![2D 보기 배경 이미지](../../assets/2d-view-background.png "2D 보기 배경 이미지"){width="360px"}



현재 표시된 이미지 위에 *다른 이미지를 오버레이*&#x200B;할 수 있습니다. ![](../../assets/2d-view-icon-background.png) <b>배경 이미지</b> 단추를 누르면 오버레이로 사용할 이미지 파일을 선택하라는 메시지가 표시됩니다.
...
<b>![](../../assets/2d-view-icon-background-0.png) 소스 이미지:</b> 오버레이 이미지를 *0%* 불투명도로 설정합니다.

<b>![](../../assets/2d-view-icon-background-100.png) 배경 이미지:</b> 오버레이 이미지를 *100%* 불투명도로 설정합니다.

<b>![](../../assets/2d-view-icon-background-50.png) 재설정:</b> 오버레이 이미지를 *50%* 불투명도로 설정합니다.
...
+++이미지 내보내기
![2D 보기 내보내기 이미지](../../assets/2d-view-export-bitmap.png "2D 보기 내보내기 이미지"){width="360px"}



현재 표시된 이미지는 *이미지 파일로 내보내기*&#x200B;할 수 있습니다. ![](../../assets/2d-view-icon-export.png) <b>이미지 저장...</b> 단추를 누르면 내보낸 파일에 대한 *위치*, *이름* 및 *파일 형식*&#x200B;을 선택하라는 메시지가 표시됩니다.
...
+++클립보드로 복사
![2D 클립보드에 복사](../../assets/2d-view-copy-clipboard.gif "2D 클립보드에 복사"){width="360px"}



현재 표시된 이미지는 *클립보드에 복사*&#x200B;할 수 있습니다. ![](../../assets/2d-view-icon-copy.png) <b>이미지를 클립보드에 복사</b> 단추를 누르면 이미지를 Adobe Photoshop과 같은 타사 소프트웨어에 붙여넣을 준비가 됩니다.
...
+++그래프 출력 전환
![2D 보기 스위치 그래프 출력](../../assets/2d-view-switch-graph-outputs.gif "2D 보기 스위치 그래프 출력"){width="360px"}



현재 표시된 이미지가 *그래프 출력*&#x200B;인 경우 ![](../../assets/2d-view-icon-view-outputs.png) <b>출력 선택</b> 단추를 사용하여 *다른 그래프 출력으로 빠르게 전환*&#x200B;할 수 있습니다.
...
+++UV 오버레이
![2D 보기 UV 오버레이](../../assets/2d-view-uv.png "2D 보기 UV 오버레이"){width="357px"}
...
+++이미지 정보
![2D 이미지 정보 보기](../../assets/2d-view-information.png "2D 이미지 정보 보기"){width="360px"}



![](../../assets/2d-view-icon-information.png) <b>이미지 정보</b> 단추를 사용하여 활성화된 <b>정보</b> 패널을 사용하여 이미지에 *정확한 픽셀 값* *과(와) 좌표*&#x200B;를 표시할 수 있습니다. 이는 예를 들어 HDR 이미지를 검사하거나 픽셀 사이의 단계가 의도된 진행을 따르는지 확인할 때 매우 유용합니다.
...
+++히스토그램
![2D 보기 막대 그래프](../../assets/2d-view-histogram.png "2D 보기 막대 그래프"){width="360px"}



![](../../assets/2d-view-icon-histogram.png) <b>막대 그래프 표시</b> 단추를 사용하여 활성화된 <b>막대 그래프</b> 패널을 사용하여 이미지의 *막대 그래프*&#x200B;를 표시할 수 있습니다.
...
![2D 보기 색상 채널](../../assets/2d-view-color-channel.png "2D 보기 색상 채널"){width="360px"}

### 색상 채널

![](../../assets/2d-view-icon-channels.png) <b>색상 채널</b> 단추를 사용하여 이미지의 단일 채널을 표시할 수 있습니다. 그러면 <b>빨강</b>, <b>녹색</b>, <b>파랑</b> 및 <b>Alpha</b> 채널 중 표시할 채널을 선택할 수 있는 콤보 상자가 열립니다. <b>RGB</b> 옵션을 선택하면 모든 채널이 있는 이미지의 일반적인 모습이 복원됩니다.
...
![2D 보기 투명도 토글](../../assets/2d-view-transparency.png "2D 보기 투명도 토글"){width="360px"}

### 투명도 토글

![](../../assets/2d-view-icon-transparency-off.png)/![](../../assets/2d-view-icon-transparency-on.png) <b>바둑판 표시</b> 단추를 사용하여 투명도 표시를 켜거나 끌 수 있습니다. 이 옵션을 활성화하면 바둑판 패턴을 사용하여 투명도가 표시됩니다.

투명도를 해석하는 방법에는 두 가지가 있으며 ![](../../assets/2d-view-icon-transparency-straight.png)/![](../../assets/3d-view-icon-transparency-premultiplied.png) <b>투명도 모드</b> 단추를 사용하여 선택할 수 있습니다.

<b>![](../../assets/2d-view-icon-transparency-straight.png) 직선:</b> 투명도 정보는 알파 채널에만 저장되며 이미지의 다른 측면에는 영향을 주지 않습니다

<b>![](../../assets/3d-view-icon-transparency-premultiplied.png) 미리 곱하기:</b> 투명도 정보는 알파 채널에 저장되며 알파 채널에 대해 효과적으로 곱하기 때문에 RGB 채널에도 영향을 줍니다

*올바른 색상*&#x200B;을 표시하려면 <b>2D 보기</b> 패널에서 이미지를 *만들* 때 적용된 투명도 방법과 일치하도록 적절한 투명도 모드를 선택해야 합니다.

![2D 보기 색상 공간](../../assets/2d-view-viewport-color-space.png "2D 보기 색상 공간"){width="360px"}

### 색상 공간

가장 정확한 색상 표현을 위해 이미지는 기본적으로 *모니터*&#x200B;에서 사용하는 것과 일치하는 *색상 공간*&#x200B;에 표시됩니다.

사용 가능한 컨트롤 및 ![](../../assets/2d-view-icon-color-space.png)/![](../../assets/2d-view-icon-color-space-linear.png) <b>색상 공간</b> 단추의 효과는 [프로젝트 설정](../../interface/preferences-window/project-settings/project-settings.md)에서 설정한 [색상 관리 모드](../../color-management/color-management.md)에 따라 달라집니다. 이 페이지의 색상 관리 섹션에서 이러한 컨트롤에 대해 자세히 알아보십시오.
...
![비트맵 페인팅 도구 보기](../../assets/2dview-paintingtools-main.png "비트맵 페인팅 도구 보기")
...
![2D 뷰 벡터 그래픽 편집기](../../assets/2dview-vectorediting-main.png "2D 뷰 벡터 그래픽 편집기")
...
* <b>레거시:</b> ![](../../assets/2d-view-icon-color-space.png) sRGB 또는 ![](../../assets/2d-view-icon-color-space-linear.png) 선형 sRGB 색상 공간에서 이미지를 디스프.레이할 수 있습니다.
* <b>Adobe ACE:</b> 색상 관리를 ![](../../assets/2d-view-icon-color-space.png) *사용*&#x200B;하고 Adobe ACE 엔진에서 감지한 *현재 모니터*&#x200B;에 가장 적합한 색상 공간을 설정하거나 ![](../../assets/2d-view-icon-color-space-linear.png) *사용 안 함* 색상 관리를 설정하고 Raw 색상 값을 사용하여 이미지를 표시할 수 있습니다.
* <b>OCIO:</b> ![](../../assets/2d-view-icon-color-space.png) *사용* 색상 관리를 설정하고 OCIO 엔진에서 감지한 대로 *현재 모니터*&#x200B;에 가장 적합한 색상 관리를 설정할 수 있습니다. 콤보 상자를 사용하고 현재 사용된 [OCIO 구성 파일](../../color-management/color-management.md)에서 사용 가능한 *디스플레이 색상 공간* 또는 ![](../../assets/2d-view-icon-color-space-linear.png) *사용 안 함* 색상 관리를 선택하고 Raw 색상 값을 사용하여 이미지를 표시합니다.
