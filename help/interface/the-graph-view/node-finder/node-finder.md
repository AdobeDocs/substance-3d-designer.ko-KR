...
그래프 보기 도구 모음에서 <b>노드 찾기 단추 ![](../../../assets/graph-node-finder.png)</b>을(를) 클릭하여 노드 찾기 도구 모음을 표시합니다. 일단 표시되면 도구 모음은 이 단추를 클릭하기만 하면 닫힙니다.
...
![노드 찾기 도구: 검색 중 그래프 통과](../../../assets/node-finder-traversal.gif "노드 찾기 도구: 검색 중 그래프 통과"){zoomable="yes"}

### 검색 쿼리

![노드 찾기 쿼리 필드](../../../assets/node-finder-query-field.png "노드 찾기 쿼리 필드"){zoomable="yes"}
...
![노드 유형](../../../assets/node-finder-node-types.png "노드 유형"){zoomable="yes"}
...
![노드 형식(합성)](../../../assets/node-finder-types-compositing.png "노드 형식(합성)"){zoomable="yes"}



그래프 합성에 대한 *노드 유형*

![노드 형식(함수)](../../../assets/node-finder-types-function.png "노드 형식(함수)"){zoomable="yes"}
...
+++원자 노드 검색
![노드 찾기 도구: &#39;Levels&#39; 유형별 검색(합성)](../../../assets/node-finder-compositing-levels.png "노드 찾기 도구: &#39;Levels&#39; 유형별 검색(합성)"){zoomable="yes"}
...
+++인스턴스 노드 검색
![노드 찾기 도구: &#39;인스턴스&#39; 유형별 검색(합성)](../../../assets/node-finder-compositing-instances.png "노드 찾기 도구: &#39;인스턴스&#39; 유형별 검색(합성)"){zoomable="yes"}



*Substance 그래프에서 &#39;인스턴스&#39; 노드 유형을 검색하는 중*

![노드 찾기 도구: &#39;인스턴스&#39; 유형(함수)으로 검색](../../../assets/node-finder-functions-instances.png "노드 찾기 도구: &#39;인스턴스&#39; 유형(함수)으로 검색"){zoomable="yes"}
...
<b>검색 옵션 단추 ![](../../../assets/node-finder-search-options.png)</b>은(는) 검색에 사용되는 설정 목록을 열고 켜거나 끌 수 있습니다.
...
![노드 찾기 검색 옵션](../../../assets/node-finder-search-options-open.png "노드 찾기 검색 옵션"){zoomable="yes"}
...
![노드 찾기 도구: 그래프 식별자로 검색](../../../assets/node-finder-functions-identifier.png "노드 찾기 도구: 그래프 식별자로 검색"){zoomable="yes"}
...
![탐색기: 패키지 콘텐츠](../../../assets/explorer-package-simple.png "탐색기: 패키지 콘텐츠"){zoomable="yes"}
...
![인스턴스 노드의 도구 설명에 있는 그래프 식별자](../../../assets/node-finder-compositing-identifier.png "인스턴스 노드의 도구 설명에 있는 그래프 식별자"){zoomable="yes"}
...
![노드 찾기 도구: 노드 변수](../../../assets/node-finder-compositing-variable.png "노드 찾기 도구: 노드 변수"){zoomable="yes"}
...
![노드 찾기 쿼리 제안](../../../assets/node-finder-available-query-suggestions.png "노드 찾기 쿼리 제안"){zoomable="yes"}



노출된 매개 변수의 식별자는 [Substance 그래프 속성](../../../compositing-graphs/graph-parameters/graph-parameters.md)에서 직접 복사하거나 편집할 수도 있습니다.

![노드 찾기 도구: 노출된 매개 변수](../../../assets/node-finder-compositing-exposed-parameter.png "노드 찾기 도구: 노출된 매개 변수"){zoomable="yes"}
...
![노드 찾기 도구: 콘솔 경고/오류에서 변수 검색](../../../assets/node-finder-console-identifier.png "노드 찾기 도구: 콘솔 경고/오류에서 변수 검색"){zoomable="yes"}
...
![노드 찾기 도구: 변수를 검색하면 해당 변수를 사용하는 Get 노드가 검색됨](../../../assets/node-finder-exposed-parameter-01.gif "노드 찾기 도구: 변수를 검색하면 해당 변수를 사용하는 Get 노드가 검색됨"){zoomable="yes"}
...
![노드 찾기 도구: UID로 검색](../../../assets/node-finder-compositing-uid-search.png "노드 찾기 도구: UID로 검색"){zoomable="yes"}
...
![노드 찾기 도구: 노드 UID 동작 복사](../../../assets/node-finder-compositing-uid-copy.png "노드 찾기 도구: 노드 UID 동작 복사"){zoomable="yes"}
...
![노드 찾기 도구: 콘솔에서 노드 UID 검색](../../../assets/node-finder-console-uid.png "노드 찾기 도구: 콘솔에서 노드 UID 검색"){zoomable="yes"}
...
<b>검색 옵션 단추 ![](../../../assets/node-finder-search-options.png)</b>을(를) 사용하면 노드 검색을 위한 <b>반복</b> 및 <b>유사 항목</b> 모드를 전환할 수 있습니다.
...
![노드 찾기: 재귀 검색](../../../assets/node-finder-recursion-01.png "노드 찾기: 재귀 검색"){zoomable="yes"}

*오른쪽의 쿼리는 아래의 인스턴스 노드를 강조 표시합니다. 왼쪽의 참조된 그래프가 해당 쿼리와 일치하기 때문입니다.*

+++예제 1
![노드 찾기: 재귀 검색 예 1](../../../assets/node-finder-recursion-01.gif "노드 찾기: 재귀 검색 예 1"){zoomable="yes"}
...
+++예제 2
![노드 찾기: 재귀 검색 예 2](../../../assets/node-finder-recursion-02.gif "노드 찾기: 재귀 검색 예 2"){zoomable="yes"}
...
![노드 찾기 도구: 퍼지 모드](../../../assets/node-finder-functions-fuzzy.png "노드 찾기 도구: 퍼지 모드"){zoomable="yes"}
