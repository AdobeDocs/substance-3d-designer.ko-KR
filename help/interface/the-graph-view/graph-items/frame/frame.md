...
![프레임(마우스 오버 상태)](../../../../assets/graph-frames-hover.png "프레임(마우스 오버 상태)")
...
포함 규칙을 충족하는 객체는 프레임에 포함된 것으로 간주됩니다. 이러한 규칙은 대상과 특별한 경우에 따라 달라진다. 아래에 나열되어 있습니다.

각 그림의 노란색 기호는 해당 프레임에 개체를 포함하기 위해 프레임 경계 내에 완전히 있어야 하는 점 또는 영역을 나타냅니다.
...
![프레임 포함: 상위 댓글](../../../../assets/frame_inclusion_comment_parented.png "프레임 포함: 상위 댓글")



![프레임 포함: 댓글](../../../../assets/frame_inclusion_comment.png "프레임 포함: 댓글")
...
![프레임: 콘텐츠에 크기 맞추기](../../../../assets/graph-frames_fit-size-to-content.png "프레임: 콘텐츠에 크기 맞추기")

그래프를 조정할 때 프레임의 내용이 더 이상 적절하게 조정되지 않을 수 있습니다. 이 경우, 하나의 중간 격자 셀의 패딩으로, 프레임의 위치와 크기를 그 내용의 범위에 맞게 자동 조절하는 것이 가능하다.
...
![프레임: 콘텐츠에 크기 맞추기(설명 포함)](../../../../assets/graph-frames_fit-description.png "프레임: 콘텐츠에 크기 맞추기(설명 포함)")
