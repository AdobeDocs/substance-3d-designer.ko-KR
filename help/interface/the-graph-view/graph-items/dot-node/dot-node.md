...
![점 노드 아이콘](../../../../assets/graphatomic-dot_1.png "점 노드 아이콘")
...
![점 노드 삽입](../../../../assets/dot-node-insert-optim.gif "점 노드 삽입"){width="512px"}
...
![점: 커넥터에서 만들기](../../../../assets/graph-dot_create-from-connector.gif "점: 커넥터에서 만들기")
...
![노드 메뉴의 점 노드](../../../../assets/dot-node-insert-menu.png "노드 메뉴의 점 노드")
...
![링크 병합](../../../../assets/dot-node-congrenate-links-optim.gif "링크 병합"){width="512px"}
...
![점 노드를 포털로 - 아이콘](../../../../assets/DotNode_Portal-1.png "점 노드를 포털로 - 아이콘")
...
![점 노드를 포털로](../../../../assets/DotNode_Portal.gif "점 노드를 포털로")
