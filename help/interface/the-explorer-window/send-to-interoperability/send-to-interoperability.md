...
![Designer에서 Substance 3D 앱으로 보내기](send-to-interoperability.resources/send-to-interoperability-01.png "Designer에서 Substance 3D 앱으로 보내기"){width="512px"}
...
![Substance 그래프의 형식 특성](send-to-interoperability.resources/send-to-interoperability-02.jpg "Substance 그래프의 형식 특성")
...
* [탐색기] 패널 위쪽의 ![](send-to-interoperability.resources/send-to-interoperability-03.jpg) <b>Publish/보내기</b> 단추를 클릭한 다음 대상 응용 프로그램에 대해 <b>보내기...</b> 옵션을 선택합니다.

</td>
<td style="border: 0;" valign="top">

![Explorer의 Publish/보내기 메뉴](send-to-interoperability.resources/send-to-interoperability-04.jpg "Explorer의 Publish/보내기 메뉴")
