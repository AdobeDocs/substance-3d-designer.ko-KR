...
![탐색기 도킹](the-explorer-window.resources/the-explorer-window-01.jpg "탐색기 도킹")
...
선택한 패키지를 ![](the-explorer-window.resources/the-explorer-window-02.png) <b>저장</b>합니다.

선택한 ![](the-explorer-window.resources/the-explorer-window-03.jpg) <b>Publish 또는 [보내기](../../interface/the-explorer-window/send-to-interoperability/send-to-interoperability.md)</b>:
...
![](the-explorer-window.resources/the-explorer-window-04.png) <b>Publish 또는 이전으로 보내기:</b> Publish 또는 이전과 동일한 설정으로 선택한 요소를 보냅니다. 이 옵션은 *현재* 세션에서 *적어도 한 번* 게시된 패키지에서만 사용할 수 있습니다.

선택한 그래프에서 ![](the-explorer-window.resources/the-explorer-window-05.jpg) <b>사용하지 않는 노드 제거</b>. 도구는 다음 규칙을 따릅니다.
...
![Publish/보내기 드롭다운 메뉴](the-explorer-window.resources/the-explorer-window-06.jpg "Publish/보내기 드롭다운 메뉴")
...
![사용하지 않는 노드 제거 드롭다운 메뉴](the-explorer-window.resources/the-explorer-window-07.jpg "사용하지 않는 노드 제거 드롭다운 메뉴")
...
<b>3D 보기에서 출력 보기:</b> 이 그래프의 출력을 [3D 보기](../../interface/3d-view/3d-view.md)로 보내 자료로 표시합니다.
...
<b>![](the-explorer-window.resources/the-explorer-window-08.jpg) 종속성:</b> 패키지를 선택하면 해당 패키지 종속성이 전용 패널에 나열됩니다.

<b>![](the-explorer-window.resources/the-explorer-window-09.jpg) 정보:</b> 현재 선택한 패키지 또는 리소스와 관련된 메타데이터를 제공합니다.
...
![종속성 패널](the-explorer-window.resources/the-explorer-window-10.jpg "종속성 패널")
...
![정보 패널](the-explorer-window.resources/the-explorer-window-11.jpg "정보 패널")
