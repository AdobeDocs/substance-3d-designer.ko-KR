...
<b> 템플릿</b> 섹션에서 그래프 템플릿을 선택할 수 있습니다. 그래프 템플릿에는 미리 구성된 노드가 포함되어 있으므로 그래프를 더 빠르게 시작할 수 있습니다. 미리 구성된 노드에는 출력 노드, 이러한 출력으로 값을 전달하는 간단한 노드(예: 템플릿에 따라 균일 색상 및 입력 노드)가 포함됩니다.
...
* **![](../../assets/mdl-template-graphs-icon.png)그래프 표시**: 템플릿은 *레이블 전용*&#x200B;으로 표시됩니다. 템플릿 디렉터리의 [Substance 3D](https://www.adobe.com/kr/products/substance3d/3d-augmented-reality.html) 파일 순서대로 표시됩니다.
