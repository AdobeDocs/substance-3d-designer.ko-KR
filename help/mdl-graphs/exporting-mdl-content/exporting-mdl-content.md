...
MDL 모듈 내보내기는 *패키지* 수준에서 수행됩니다. 지정된 패키지에 대한 MDL 모듈을 내보내려면 [탐색기](../../interface/the-explorer-window/the-explorer-window.md)에서 ![](../../assets/mdl-export-module-icon.png) <b>MDL 모듈 내보내기</b> 버튼을 클릭하거나 *패키지의 컨텍스트 메뉴*&#x200B;에서 동일한 옵션을 선택합니다. 내보낸 MDL 모듈의 대상 위치와 이름을 선택하면 내보내기 프로세스 중에 기록된 메시지 목록이 있는 <b>내보내기 보고서</b> 대화 상자가 표시됩니다.
...
![MDL 내보내기 경로](../../assets/mdl-export-module.png "MDL 내보내기 경로")
...
MDL 모듈 보관 파일 내보내기는 *패키지* 수준에서 수행됩니다. 지정된 패키지에 대한 MDL 모듈 아카이브를 내보내려면 [탐색기](../../interface/the-explorer-window/the-explorer-window.md)에서 ![](../../assets/mdl-export-module-icon.png) <b>MDL 모듈 아카이브 내보내기</b> 버튼을 클릭하거나 *패키지의 컨텍스트 메뉴*&#x200B;에서 동일한 옵션을 선택합니다. 내보낸 MDL 모듈 아카이브의 대상 위치와 이름을 선택하면 내보내기 프로세스 중에 기록된 메시지 목록과 함께 <b>보고서 내보내기</b> 대화 상자가 표시됩니다.
...
![MDR 내보내기 경로](../../assets/mdl-export-archive.png "MDR 내보내기 경로")
...
![MDLE 내보내기 경로](../../assets/mdl-export-encapsulated.png "MDLE 내보내기 경로")
